...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-black text-primary-content  mt-24">
  <aside>
    ...
    <p className="font-bold">
      KHAN Industries Ltd. <br/>Providing corporate event management services since 1992
    </p> 
