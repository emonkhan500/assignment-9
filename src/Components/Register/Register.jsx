          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <form onSubmit={handleRegister} className="card-body">
              ...
              <div className="form-control mt-6">
                ...
                <button  onClick={()=>{handleGoogleSignIn(googleSignIn)}} className="btn btn-primary mt-6" >sign in with Google</button>
              </div>
            </form>
            <p className='text-center'>HAVE ACCOUNT? <Link to="/login"><button className='btn btn-link' > Login</button></Link>  </p>
          </div>
